<%-- 
    Document   : ZaboravljenaLozinka2
    Created on : May 15, 2019, 12:35:49 AM
    Author     : OEM
--%>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-success hideAfter"><strong><%=(request.getAttribute("succMessage")==null)?"" 
                                    ...
                                    <% }%>
                    <form class="form-horizontal" name="forma" method="post" action="ZaboravljenaLozinka2Servlet" id="forma">
                        <div class="form-group">
                            <label for="newPass" class="cols-sm-2 control-label">Nova lozinka</label>
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="zmdi zmdi-key" aria-hidden="true"></i></span>
                                    <input type="password" class="form-control" name="newPass">
                                    <input type="hidden" name="userID" value="<%=request.getAttribute("idUser")%>">
                                    <input type="hidden" name="imejl" value="<%=request.getAttribute("imejl")%>">
                                </div>
                                <span class="small alert">Unesite novu lozinku</span>
                            </div>
                        </div>
