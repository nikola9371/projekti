...
<html>
    <head>
        ...
        <title>Update administators</title>
        <script>
    ...
    <body>
        ...
        $podaci=$korisnik->uzmiPodatkeAdmin($_GET["id"]); 
        ...
        <?php
            ...
            if($korisnik->izmeni_admin($_GET["id"], $name, $email, $username)){
        ...
        ?>
        <a id="backarrow" href="lista-administratora.php" style="padding: 10px 15px; background: #414141; color: #d9d9d9; text-decoration: none;"><img src="pictures/arrow-left.png" height="25" width="25" style="vertical-align: middle; margin-right: 2px;" >Povratak na prethodnu stranu</a>
