<%-- 
    Document   : DodajNalog
    Created on : Jun 26, 2019, 4:09:35 PM
    Author     : OEM
--%>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <form class="form-horizontal" name="forma" method="post" action="DodajNalogServlet">
                        <input type="hidden" name="type" value="adminNalog">
                                ...
                                <div class="form-group">
                                    <label for="name" class="cols-sm-2 control-label">Tip naloga</label>
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-handshake-o fa-lg" aria-hidden="true"></i></span>
                                            <select name="tipNaloga" class="form-control">
