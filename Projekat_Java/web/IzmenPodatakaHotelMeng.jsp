<%-- 
    Document   : IzmenPodatakaHotelMeng
    Created on : May 4, 2019, 12:25:56 AM
    Author     : OEM
--%>
...
<!--===============================================================================================-->
    ...
    <body>
        <% 
            ...
            ArrayList<HotelBean> hotelInfo=menz.HotelExportDataMenz(Integer.parseInt(sesija.getAttribute("userID").toString()));
