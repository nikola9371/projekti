<%-- 
    Document   : PostaviSliku
    Created on : Jun 24, 2019, 3:22:56 PM
    Author     : OEM
--%>
...
<!--===============================================================================================-->
    ...
    <body>
        <%
            ...
            ArrayList<MenadzerBean> mendzinfo=menz.MenzExportData(Integer.parseInt(sesija.getAttribute("userID").toString()));
        %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-success hideAfter"><strong><%=(request.getAttribute("succMessage")==null)?"" 
                                    ...
                                    <form id="form1" action="IzmeniSlikuServlet" method="post">
                                        ...
                                        <input type="hidden" name="idMenz" value="<%=sesija.getAttribute("userID")%>">
                                        <div class="form-group">
                                            <%for(MenadzerBean elem:mendzinfo){%>
