...
namespace WpfApp1
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="Kolokvijum1")]
    ...
    partial void DeleteSoba(Soba instance);
		...
		public BolnicaDataContext() : 
				base(global::WpfApp1.Properties.Settings.Default.Kolokvijum1ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnPrioritetChanging(int value);
    ...
    partial void OnSobaIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Ime", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		public string Ime
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Prezime", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Prioritet", DbType="Int NOT NULL")]
